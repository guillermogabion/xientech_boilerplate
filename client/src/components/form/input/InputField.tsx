...
interface InputProps {
  ...
  placeholder?: string;
  value?: string | number;
  defaultValue?: string | number; // Added this line
...
const Input: FC<InputProps> = ({
  ...
  placeholder,
  value,
  defaultValue, // Added this line
  onChange,
  onBlur, // Destructured
  onFocus, // Destructured
  autoComplete, // Destructured
  className = "",
  min,
  max,
  step,
  ...
  return (
    <div className="relative">
      ...
      <input
        ...
        value={value}
        defaultValue={defaultValue} // Added this line
        onChange={onChange}
        onBlur={onBlur} // Passed to input
        onFocus={onFocus} // Passed to input
        autoComplete={autoComplete} // Passed to input
        min={min}
        max={max}
        step={step}
        disabled={disabled}
